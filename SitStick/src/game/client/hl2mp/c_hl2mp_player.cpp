...
#define	HL2_WALK_SPEED 500
#define	HL2_NORM_SPEED 500
#define	HL2_SPRINT_SPEED 500

static ConVar cl_playermodel( "cl_playermodel", "none", FCVAR_USERINFO | FCVAR_ARCHIVE | FCVAR_SERVER_CAN_EXECUTE, "Default Player Model");
static ConVar cl_defaultweapon( "cl_defaultweapon", "weapon_pistol", FCVAR_USERINFO | FCVAR_ARCHIVE, "Default Spawn Weapon");
